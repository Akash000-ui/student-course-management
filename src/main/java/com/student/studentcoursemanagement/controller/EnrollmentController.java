...
public class EnrollmentController {
    ...
    /**
     * Mark a video as completed in a course
     * PUT /api/enrollments/course/{courseId}/complete-video
     */
    @PutMapping("/course/{courseId}/complete-video")
    @PreAuthorize("hasRole('USER') or hasRole('ADMIN')")
    public ResponseEntity<ApiResponse<EnrollmentResponseDTO>> completeVideo(
            @PathVariable String courseId,
            Authentication authentication) {
        ...
        EnrollmentResponseDTO enrollment = enrollmentService.completeVideo(userId, courseId);
